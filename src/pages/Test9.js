  ...
  return (
    <>
      ...
      <div className="flex flex-no-wrap">
        ...
        <div>
          <div
            className="h-14 w-14 hidden bg-yellow-300  absolute  mt-16 -mr-10 lg:flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
            id="mobile-toggler"
            onClick={dashboardOpened}
          >
            <svg
          ...
          {show && (
            <>
              {" "}
              <div className="w-80 absolute sm:relative bg-gray-100  md:h-screen  flex-col justify-between flex">
                <div
                  className="h-14 w-14 bg-yellow-300 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
                  id="mobile-toggler"
                ...
                <div className="">
                  ...
                  <ul className="mt-12 w-80 ">
                    <li className="flex w-72 px-4 justify-between text-gray-400 h-14 rounded-r-full hover:bg-yellow-100 hover:text-gray-500 cursor-pointer  mb-6">
                      <div className="flex items-center">
                        ...
                        <span className="text-xl  ml-2">Classes</span>
                      </div>
                    </li>
                    <li className="flex w-72 px-4 justify-between text-gray-400 h-14 rounded-r-full hover:bg-yellow-100 hover:text-gray-500 cursor-pointer items-center mb-6">
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={28}
                    ...
                    <button className="flex px-4  w-72 justify-between text-gray-300 h-14 rounded-r-full hover:bg-yellow-100 hover:text-gray-500 cursor-pointer items-center mb-6">
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={28}
                    ...
                    <div className="py-1 px-3 bg-gray-100 rounded text-gray-500 flex items-center justify-center text-xs">
                      8
                    </div>
                  </li>
                  <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
        ...
        <div>
          <div
            className="h-10 w-10  bg-yellow-300 absolute lg:hidden  mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
            id="mobile-toggler"
            onClick={dashboardOpened}
          >
            <svg
          ...
          {show && (
            <>
              <div
                className="w-64 z-40 absolute bg-gray-800 shadow md:h-screen flex-col justify-between sm:hidden  transition duration-150 ease-in-out"
                id="mobile-nav"
              >
                <div
